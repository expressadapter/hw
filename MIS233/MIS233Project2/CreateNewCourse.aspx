<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateNewCourse.aspx.cs" Inherits="CreateNewCourse" %>

<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
         <div id="right_block">
             <span class="modul">&nbsp;<span class="inr_bllk">
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Course Code:</p>
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        ...
        <asp:Button ID="addUser" runat="server" Text="Create Course" OnClick="addUser_Click" />
    </p>
         </div>
         </span></span>
