...
public partial class files : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cm.CommandText = "SELECT *  FROM UploadedMaterials";
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        cmd.Connection = conn;
        cmd.CommandText = "Delete From UploadedMaterials Where fileid=" + deleteid.Text;
        ...
        if (affected == 1)
        {
            Label2.Text = "File is deleted from list";
            Response.Redirect("/files.aspx");
        }
        else
        {
            Label2.Text = "Error, file can not deleted";
        }
    }
}