...
public partial class CreateNewCourse : System.Web.UI.Page
{
    ...
    protected void addUser_Click(object sender, EventArgs e)
    {
        ...
        cm.CommandText = @"INSERT INTO [Courses]([CourseCode] ,[CourseName],[Teacher] )
        ...
        if (affected == 1)
        {
            passwordErrorLabel.Text = "Course added to database";
        }
        else
        {
            passwordErrorLabel.Text = "Course can not added to database";
        }
