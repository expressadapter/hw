<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DeactivateActivatePage.aspx.cs" Inherits="DeactivateActivatePage" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <p>
        ...
        <asp:Button ID="deactivate" runat="server" Text="Deactivate" OnClick="deactiveUser_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="activate" runat="server" Text="Activate" OnClick="activateUser_Click" />
    </p>
      </div>
     </asp:Content>
